...
export default function TechStack() {
  ...
  return (
    <section id="skills" className="relative bg-black text-white pb-32 overflow-hidden min-h-screen flex flex-col justify-start">
      ...
      <div className={`absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-blue-600/20 rounded-full mix-blend-screen filter blur-[130px] pointer-events-none z-0 transition-opacity duration-1000 ease-in-out ${animationsEnabled ? 'animate-ambient-glow' : 'opacity-20'}`} />
      <div className={`absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-orange-600/20 rounded-full mix-blend-screen filter blur-[130px] pointer-events-none z-0 transition-opacity duration-1000 ease-in-out ${animationsEnabled ? 'animate-ambient-glow-delayed' : 'opacity-20'}`} />
